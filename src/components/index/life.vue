<template>
    <div class="m-life">
        <el-row>
            <ul class="nav">
                <li>
                    <router-link :to="{name:''}" class="takeout">美团外卖</router-link>
                </li>
                <li>
                    <router-link :to="{name:''}" class="">猫眼电影</router-link>
                </li>
                <li>
                    <router-link :to="{name:''}" class="">美团酒店</router-link>
                </li>
                <li>
                    <router-link :to="{name:''}" class="apartment">民宿/公寓</router-link>
                </li>
                <li>
                    <router-link :to="{name:''}" class="business">商家入驻</router-link>
                </li>
                <li>
                    <router-link :to="{name:''}" class="">美团公益</router-link>
                </li>
            </ul>
        </el-row>
