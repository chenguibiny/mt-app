  ...
  <div class="page-login">
    ...
    <div class="login-panel">
      ...
      <div class="form">
        ...
        <el-input :class="{error: error && !userName}" v-model="userName" placeholder="用户名" prefix-icon="el-icon-user"></el-input>
        ...
        <p class="reg">
          <span>还没有账号？</span>
          <router-link :to="{name:'register'}" class>免费注册</router-link>
        </p>
